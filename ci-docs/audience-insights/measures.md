...
量值可協助您更清晰地了解客戶行為和業務績效。 它們會從[整合個人資料](data-unification.md)中檢查相關的值。 例如，如果一類商務要看 *每位客戶的總花費*，來了解各客戶的購買歷史，或要看 *公司的總銷售* 的量值，來了解整體商務的總營收水準。  
...
1. 在 **設定期間** 區段中，定義要使用的資料時間範圍。 選擇是否要選取 **所有時間** 讓新量值涵蓋整個資料集。 或者，如果您要讓量值聚焦在 **特定期間**。
