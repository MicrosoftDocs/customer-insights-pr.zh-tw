...
> [!TIP]
> 嘗試使用範例資料的交易流失預測教學課程：[交易流失預測 (預覽版) 範例指南](sample-guide-predict-transactional-churn.md)。
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>提供基準指標帳戶的選項清單 (商務客戶專用)
