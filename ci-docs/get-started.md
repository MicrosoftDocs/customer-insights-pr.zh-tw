...
統一設定檔是取得見解並對資料進行動作的基礎。 從不同的來源取得資料，並執行資料整合程序以結合成統一設定檔。 指定已擷取實體之間的關聯，並使用擴充功能將資訊新增至設定檔。
...
## <a name="step-4-enhance-unified-profiles-with-predictions-activities-and-measures"></a>步驟 4：利用預測、活動及量值來增強統一設定檔
